...
class MockDataService {
  ...
  // Static cycles and recommendations data - 1 per day for last 7 days
  static final List<ActivityItem> _cyclesRecom = [
    // Today (Day 0)
    ActivityItem(
      ...
      statusColor: 'red',
      icon: Icons.warning,
      description: 'Carbon and nitrogen levels need more compost for acceleration. Add water to maintain optimal moisture levels.',
      category: 'Recoms',
      timestamp: _daysAgo(0, hour: 11, minute: 15),
    ),
    ...
    ActivityItem(
      ...
      description: 'Balance your greens with more brown materials like dried leaves or cardboard to optimize decomposition.',
      category: 'Recoms',
      timestamp: _daysAgo(2, hour: 14, minute: 30),
    ),
    ...
    ActivityItem(
      ...
      category: 'Cycles',
      timestamp: _daysAgo(3, hour: 16, minute: 45),
    ),
    ...
    ActivityItem(
      ...
      statusColor: 'green',
      icon: Icons.thumb_up,
      description: 'Temperature is in the ideal range (35-40°C). Continue current maintenance routine.',
      category: 'Recoms',
      timestamp: _daysAgo(4, hour: 10, minute: 20),
    ),
    ...
    ActivityItem(
      ...
      category: 'Cycles',
      timestamp: _daysAgo(5, hour: 13, minute: 15),
    ),
    ...
    ActivityItem(
      ...
      statusColor: 'grey',
      icon: Icons.air,
      description: 'Turn the compost pile to improve oxygen flow and speed up decomposition process.',
      category: 'Recoms',
      timestamp: _daysAgo(6, hour: 8, minute: 30),
    ),
  ];
  ...
  // Get cycles and recommendations
  static List<ActivityItem> getCyclesRecom() {
    return List.from(_cyclesRecom);
  }

  // Get all activities combined and sorted by timestamp
  static List<ActivityItem> getAllActivities() {
    final combined = [..._substrates, ..._alerts, ..._cyclesRecom];
