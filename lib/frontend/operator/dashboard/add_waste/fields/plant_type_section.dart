...
class PlantTypeSection extends StatelessWidget {
  ...
  String _getPlantNeedsInfo() {
    ...
    final plant = options.firstWhere((option) => option['value'] == selectedPlantType, orElse: () => {'needs': ''});
    return plant['needs'] ?? '';
  }
  ...
  List<DropdownMenuItem<String>> _getPlantTypeItems() {
    if (selectedWasteCategory == null) {
      return const [
        DropdownMenuItem(value: null, enabled: false, child: Text('Select category first')),
      ];
    }
    final options = plantTypeOptions[selectedWasteCategory] ?? [];
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: Icon(Icons.local_florist_outlined, size: 18),
          ),
