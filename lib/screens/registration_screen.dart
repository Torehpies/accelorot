...
class RegistrationScreen extends StatefulWidget {
  const RegistrationScreen({super.key}); // ✅ Only one constructor
  ...
  Future<void> _registerUser() async {
    ...
    try {
      ...
      if (result['success'] == true) {
        ...
        showSnackbar(context, result['message'] ?? 'Registration failed', isError: true);
      }
    } catch (e) {
      if (!mounted) return;
      setState(() => _isLoading = false);
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: Colors.teal.withOpacity(0.3), // ✅ Fixed
                                blurRadius: 15,
                        ...
                        // Role Selection (Optional – currently hardcoded)
                        // You can add a DropdownButton here if needed
