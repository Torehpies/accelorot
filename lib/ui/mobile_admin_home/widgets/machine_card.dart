// lib/ui/mobile_admin_home/widgets/machine_card.dart
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.precision_manufacturing, size: 40, color: Colors.teal),
                      ),
                  ...
                  Positioned(top: 4, right: 4, child: StatusIndicator(isArchived: machine.isArchived, size: 12)),
                ],
              ),
            ),
          ),
