// lib/ui/mobile_admin_home/widgets/operator_detail_dialog.dart
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                const Text('Operator Details', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                StatusIndicator(isArchived: operator.isArchived, showText: true, size: 12),
              ],
            ),
           ...
           _buildDetailRow(
          'Date Added',
           _formatDate(operator.addedAt ?? DateTime.now()),
        ),
