...
class AdminStats {
  ...
  AdminStats({required this.userCount, required this.machineCount});

  /// Create a copy with modified fields
  AdminStats copyWith({int? userCount, int? machineCount}) {
    return AdminStats(
  ...
  Map<String, dynamic> toMap() {
    return {'userCount': userCount, 'machineCount': machineCount};
  }
}
