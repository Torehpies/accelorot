// lib/ui/activity_logs/view/alert_detail_view.dart
...
/// Detail view for alerts (matches Image 3 design)
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'View in-depth information about this alert.',
                        style: TextStyle(
                          fontFamily: 'DM Sans',
                          fontSize: 13,
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: AppSpacing.lg),
                  _buildField('Measurement Value', item.value),
                  const SizedBox(height: AppSpacing.lg),
                  _buildField(
                    'Description',
                    item.description,
