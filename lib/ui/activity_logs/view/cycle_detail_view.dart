// lib/ui/activity_logs/view/cycle_detail_view.dart
...
/// Detail view for cycles/recommendations (matches Image 2 design)
class CycleDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final title = isRecommendation ? 'View Recommendation' : 'View Cycle';
    final subtitle = isRecommendation
