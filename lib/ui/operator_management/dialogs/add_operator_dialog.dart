// lib/ui/operator_management/dialogs/add_operator_dialog.dart
...
class _AddOperatorDialogState extends ConsumerState<AddOperatorDialog> {
  ...
  Future<void> _handleSubmit() async {
    ...
    final result = await WebConfirmationDialog.show(
      ...
      title: 'Add Operator',
      message:
          'Are you sure you want to add this operator? An invitation will be sent to their email.',
  ...
  Widget build(BuildContext context) {
    ...
    return BaseDialog(
      title: 'Add Operator',
      subtitle: 'Fill in the details below to invite a new operator.',
