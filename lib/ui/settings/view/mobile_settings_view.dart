            ...
            SettingsSection(
              ...
              children: [
                ...
                SettingsSwitchTile(
                  ...
                  onChanged: (value) {
                    ref.read(settingsProvider.notifier).toggleEmailUpdates(value);
                  },
                ),
              ],
            ),
            ...
            SettingsSection(
              ...
              children: [
                ...
                SettingsSwitchTile(
                  ...
                  onChanged: (value) {
                    ref.read(settingsProvider.notifier).toggleEmailReports(value);
                  },
                ),
                ...
                SettingsSwitchTile(
                  ...
                  onChanged: (value) {
                    ref.read(settingsProvider.notifier).toggleTemperatureAlerts(value);
                  },
                ),
                SettingsSwitchTile(
                  ...
                  onChanged: (value) {
                    ref.read(settingsProvider.notifier).toggleMoistureAlerts(value);
                  },
                ),
                SettingsSwitchTile(
                  icon: Icons.air,
                  ...
                  onChanged: (value) {
                    ref.read(settingsProvider.notifier).toggleOxygenAlerts(value);
                  },
                ),
              ],
            ),
