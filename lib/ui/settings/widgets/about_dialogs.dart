...
class AboutDialogs {
  static Future<void> showPrivacyPolicy(BuildContext context) =>
      showDialog(context: context, builder: (_) => const _PolicyDialog(type: _PolicyType.privacy));

  static Future<void> showTermsOfService(BuildContext context) =>
      showDialog(context: context, builder: (_) => const _PolicyDialog(type: _PolicyType.terms));

  static Future<void> showHelpSupport(BuildContext context) =>
      showDialog(context: context, builder: (_) => const _HelpSupportDialog());

  static Future<void> showAppInfo(BuildContext context) =>
      showDialog(context: context, builder: (_) => const _AppInfoDialog());
}
...
class _PolicyDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final title = type == _PolicyType.privacy ? 'Privacy Policy' : 'Terms of Service';
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(
                      type == _PolicyType.privacy ? Icons.privacy_tip_outlined : Icons.description_outlined,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _bullets(['Name and contact information (email, phone number)', 'Organization or barangay affiliation', 'Device location (with your consent)']),
        _subsection('Composting System Data', 'Our IoT sensors automatically collect:'),
        _bullets(['Temperature readings inside the drum', 'Moisture levels of organic materials', 'Rotation frequency and duration', 'Waste volume and processing metrics', 'System alerts and maintenance logs']),
        _subsection('Usage Data', 'We automatically collect information about your interaction with our app:'),
        _bullets(['Device type and operating system', 'App usage patterns and preferences', 'Log data and error reports']),
        _section('3. How We Use Your Information', 'We use the collected information for:'),
        _bullets(['Operating and maintaining the composting system', 'Sending real-time alerts and notifications', 'Generating composting reports and analytics', 'Improving our products and services', 'Communicating updates and support information', 'Complying with RA 9003 reporting requirements']),
        _section('4. Data Sharing and Disclosure', 'We may share your information with:'),
        _bullets(['Local Government Units (LGUs): Aggregated waste management data for compliance reporting', 'Service Providers: Third parties who assist in operating our service', 'Research Partners: Anonymized data for environmental research', 'Legal Requirements: When required by Philippine law or government agencies']),
        ...
        _section('7. Your Rights', 'Under the Data Privacy Act of 2012 (RA 10173), you have the right to:'),
        _bullets(['Access your personal data', 'Correct inaccurate information', 'Object to data processing', 'Request data deletion', 'Data portability', 'Lodge complaints with the National Privacy Commission']),
        _section('8. Contact Us', 'For privacy-related inquiries:'),
        _contactInfo(),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _section('2. Description of Service', 'Accel-O-Rot provides a smart composting solution that includes:'),
        _bullets(['Automated rotary drum composting system', 'IoT-enabled monitoring sensors for temperature and moisture', 'Mobile application for real-time monitoring and control', 'Data analytics and reporting features']),
        _section('3. User Responsibilities', 'As a user of our Service, you agree to:'),
        _bullets(['Provide accurate and complete registration information', 'Maintain the security of your account credentials', 'Use the composting system according to provided guidelines', 'Not misuse or tamper with the monitoring equipment', 'Comply with all applicable environmental regulations']),
        _section('4. Acceptable Use', 'You agree not to:'),
        _bullets(['Use the Service for any unlawful purpose', 'Attempt to gain unauthorized access to our systems', 'Interfere with or disrupt the Service', 'Reverse engineer or attempt to extract source code', 'Use the composting system for hazardous or prohibited materials']),
        ...
        _section('10. Contact Information', 'For questions about these Terms, please contact us at:'),
        _contactInfo(),
      ],
    );
  }
      ...
      title: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.help_outline, color: AppColors.green100, size: 22),
          ),
          const SizedBox(width: 12),
